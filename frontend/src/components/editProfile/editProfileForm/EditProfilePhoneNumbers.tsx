...
import { EditProfileFormNumbersProps } from "../types";
...
const EditProfilePhoneNumbers = (props: EditProfileFormNumbersProps) => {
  const { numbers } = props;
  ...
  return (
    <Grid container>
      <Grid
        className={EditProfileFromStyle.label}
        key={`label1`}
        container
        item
        xs={12}
          ...
          numbers.map((n, i) => {
            return (
              <Grid
                ...
                sm={12}
                md={12}
                className={classes.numbersRoot}
              >
                <Grid container item xs={12} sm={6}>
                  <input
                    className={EditProfileFromStyle.input}
                    type="text"
                    value={n.type}
                    name={"type"}
                    onChange={(e) => props.handleOnNumbersChange(e, i)}
                  />
                </Grid>
                <Grid
                  container
                  ...
                  xs={12}
                  sm={6}
                  className={EditProfileFromStyle.numberInputLabel}
                >
                  ...
                  >
                    <button
                      ...
                      onClick={(e) => props.handleOnNumberRemove(i)}
                    >
